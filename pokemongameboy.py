...
ANCHO_VENTANAGAMEBOY = 1900
ALTO_VENTANAGAMEBOY = 1000
MRG_SUP_GAMEBOY = 200
MRG_IZQ_GAMEBOY = 500
...
TITLE_Y = 70 + MRG_SUP_GAMEBOY#######sacar de variables globales y mover a las funciones correspondientes? 
MRG_HORZ_BOTONES = 70
ALTO_BOTONES = 50
ESP_ENTRE_BOTON = 30
...
def menu_principal(): 
    print ('menu principal exssd')
    gamelib.draw_begin()
    gamelib.draw_image('gameboy3.gif', VACIO, VACIO)
    gamelib.draw_rectangle(MRG_IZQ_GAMEBOY, MRG_SUP_GAMEBOY, MRG_IZQ_GAMEBOY + ANCHO_VENTANA, MRG_SUP_GAMEBOY + ALTO_VENTANA)
...
def navegacion(x, y, juego): #implementado con diccionarios
    ...
    elif juego == 'menu principal' and x > ANCHO_VENTANA // 2 + ESP_ENTRE_BOTON and x < ANCHO_VENTANA - MRG_HORZ_BOTONES \
